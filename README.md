...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/patient-unit-f0a6)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/patient-unit-f0a6
```

A live public deployment of this template is available at [https://patient-unit-f0a6.templates.workers.dev](https://patient-unit-f0a6.templates.workers.dev)
